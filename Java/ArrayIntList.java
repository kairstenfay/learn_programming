...
// Note: This is an improved version of the class discussed in lecture.
// Not all of these methods were discussed in lecture - we will 
// continue discussing ArrayIntList on Friday!
...
public class ArrayIntList {
    ...
    public int maxCount() { 
      ...
      for (int i=0; i < size - 1; i ++) { 
         int freq = 1;
         int curVal = elementData[i];
         while (curVal == elementData[i + 1]) { 
            freq++;
            i++;
         }
